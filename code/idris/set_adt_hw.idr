...
set_union (mkSet s1) (mkSet s2) = mkSet (combine s1 s2)
...
list_difference l1 (h2 :: t2) = ite (member h2 l1) (list_difference (list_remove h2 l1) t2) (list_difference l1 t2)
...
pairs: a -> list b -> list (pair a b)
pairs v nil = nil
pairs h1 (h2 :: t2) = (mkPair h1 h2) :: (pairs h1 t2)

-- given a list of a and a list of b, return a list of all a-b pairs
all_pairs: list a -> list b -> list (pair a b)
all_pairs nil l2 = nil
all_pairs (h1 :: t1) l2 = (pairs h1 l2) ++ (all_pairs t1 l2)
...
-- cardinality of the powerset of a set of cardinality n is 2^n.
-- set_powerset: (s: set a) -> set (set a)
-- Hints: powerset of no elements = empty, powerset of 1 element = set
-- of value and empty, set empty and 1 and 2 and 1+2
-------------------------------------
...
set_toString (mkSet s) = "{" ++ (toStringList s) ++ "}"
